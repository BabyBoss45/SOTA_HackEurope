      ...
      <div className="flex items-center justify-center gap-2">
        {[1, 2, 3].map((s) => (
          <div key={s} className="flex items-center gap-2">
            ...
            {s < 3 && <div className="h-0.5 w-12 bg-[color:var(--border-subtle)]" />}
          </div>
        ))}
      </div>
      ...
      {step === 1 && (
        <section className="glass rounded-2xl p-6 space-y-5">
          ...
          <div>
            ...
            <input
              type="text"
              className="w-full rounded-lg border border-[var(--border)] bg-[color:var(--surface-1)] px-4 py-3 text-sm"
      ...
      {step === 2 && (
        <section className="glass rounded-2xl p-6 space-y-5">
          ...
          <div>
            ...
            <input
              type="url"
              className="w-full rounded-lg border border-[var(--border)] bg-[color:var(--surface-1)] px-4 py-3 text-sm font-mono"
          ...
          {testResult && (
            ...
            >
              ...
              <pre className="mt-2 text-xs bg-[color:var(--surface-1)] rounded p-2 overflow-auto max-h-32">
...
\`\`\``}
          ...
          <div className="rounded-lg border-2 border-yellow-200 bg-yellow-50 p-4">
            ...
            <div className="mt-2 space-y-1 text-xs text-[color:var(--foreground)]">
