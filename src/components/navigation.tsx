  ...
  return (
    <>
      ...
      >
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center gap-3">
              <ThemeToggle />
              {loading ? (
                <div className="w-20 h-8 bg-[color:var(--surface-1)] rounded-lg animate-pulse" />
              ) : user ? (
                <div className="flex items-center gap-3">
                  ...
                  <button
                    onClick={() => signOut()}
                    className="flex items-center gap-2 px-3 py-1.5 rounded-lg text-sm font-medium text-[color:var(--text-muted)] hover:text-[color:var(--foreground)] hover:bg-[color:var(--surface-hover)] transition-all"
                  >
                    <LogOut size={16} />
                    <span>Sign Out</span>
                  </button>
            ...
            <div className="md:hidden flex items-center gap-2">
              ...
              <button
                ...
                className="p-2 text-[color:var(--text-muted)] hover:text-[color:var(--foreground)]"
              >
        ...
        {/* Mobile Menu */}
        {isMobileMenuOpen && (
          <div className="md:hidden bg-[color:var(--surface-2)] backdrop-blur-xl border-t border-[color:var(--border-subtle)]">
            <div className="px-4 py-4 space-y-1">
              ...
              {/* Mobile Auth */}
              <div className="pt-3 mt-3 border-t border-[color:var(--border-subtle)]">
                {loading ? (
                  <div className="w-full h-10 bg-[color:var(--surface-1)] rounded-lg animate-pulse" />
                ) : user ? (
                  <>
                    <div className="px-4 py-2 text-sm text-[color:var(--text-muted)]">
                      {user.displayName || user.email}
                    </div>
                    <button
                      onClick={() => {
                      ...
                      className="flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium text-[color:var(--text-muted)] hover:text-[color:var(--foreground)] hover:bg-[color:var(--surface-hover)] transition-all w-full"
                    >
                      <LogOut size={18} />
                      <span>Sign Out</span>
                    </button>
