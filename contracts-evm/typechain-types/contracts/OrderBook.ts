...
export interface OrderBook extends BaseContract {
  ...
  bids: TypedContractMethod<
    [arg0: BigNumberish],
    [
      [bigint, bigint, string, bigint, bigint, string, bigint, boolean] & {
        id: bigint;
        jobId: bigint;
        agent: string;
        priceUsdc: bigint;
  ...
  createJob: TypedContractMethod<
    [metadataURI: string, maxBudgetUsdc: BigNumberish, deadline: BigNumberish],
    [bigint],
    "nonpayable"
  >;
  ...
  getBid: TypedContractMethod<
    [bidId: BigNumberish],
    [OrderBook.BidStructOutput],
    "view"
  >;

  getJob: TypedContractMethod<
    [jobId: BigNumberish],
    [OrderBook.JobStructOutput],
    "view"
  >;
