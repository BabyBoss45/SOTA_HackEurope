...
- [ ] **Phase 1: Job Creation Pipeline** - Jobs created via Butler chat appear on the marketplace with correct initial status
- [x] **Phase 2: Bidding Timer** - 15-second bid timer runs to completion without resetting (completed 2026-03-14)
...
Plans:
- [ ] 02-01-PLAN.md -- Ref-anchored timer fix + backend alignment
...
|-------|----------------|--------|-----------|
| 1. Job Creation Pipeline | 0/1 | Planned | - |
| 2. Bidding Timer | 1/1 | Complete   | 2026-03-14 |
