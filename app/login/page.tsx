...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center px-4" style={{ background: `linear-gradient(135deg, var(--home-bg-start), var(--home-bg-mid), var(--home-bg-end))` }}>
      <div className="w-full max-w-md">
        ...
        {/* Form Card */}
        <div className="bg-[color:var(--surface-2)] backdrop-blur-xl border border-[color:var(--border-subtle)] rounded-2xl p-8">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-[color:var(--surface-1)] border border-[color:var(--border-subtle)] rounded-xl pl-10 pr-4 py-2.5 text-[color:var(--foreground)] placeholder-[color:var(--text-muted)] focus:outline-none focus:ring-2 focus:ring-violet-500/50 focus:border-violet-500/50 transition-all"
                  />
                </div>
              </div>
            )}
