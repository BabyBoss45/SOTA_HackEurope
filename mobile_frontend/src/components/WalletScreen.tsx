...
import { baseSepolia } from "@/src/wagmiConfig";
...
export default function WalletScreen() {
        ...
        >
          <div className="wallet-connect-hero">
            ...
            <p className="wallet-connect-sub">
              Link your wallet to view balances, sign transactions, and interact with SOTA Butler on Base.
            </p>
          </div>
  ...
  const explorerUrl = `${baseSepolia.blockExplorers.default.url}/address/${address}`;
  ...
  return (
    <div className="wallet-screen">
      ...
      >
        ...
        <span className="wallet-status-network">Base Sepolia Testnet</span>
      </motion.div>
